...
export const mcpGatewaySecurity: DiagramDef = {
  ...
  nodes: [
    ...
    { id: 'onplat', label: 'On-Platform MCP Server', sublabel: 'auth: none', kind: 'service', icon: 'server', position: { x: 1150, y: 40 }, width: 300 },
    { id: 'copilot', label: 'GitHub Copilot MCP', sublabel: 'auth: forward_token', kind: 'external', icon: 'globe', position: { x: 1150, y: 260 }, width: 300 },
    { id: 'figma', label: 'Figma MCP', sublabel: 'auth: oauth_passthrough', kind: 'external', icon: 'globe', position: { x: 1150, y: 480 }, width: 300 },
    { id: 'ghe', label: 'GitHub Enterprise MCP', sublabel: 'auth: OIDC / OAuth', kind: 'external', icon: 'globe', position: { x: 1150, y: 700 }, width: 300 },
    { id: 'sso', label: 'Tanzu SSO (p-identity)', sublabel: 'OIDC provider', kind: 'security', icon: 'key', position: { x: 1610, y: 700 }, width: 300 },
