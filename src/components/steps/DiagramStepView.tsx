    ...
    <div className="flex h-full flex-col px-10 py-8">
      ...
      {step.narrative && (
        <motion.div
          ...
          className="glass-panel mb-4 flex max-h-28 shrink-0 items-start gap-3 overflow-y-auto rounded-xl px-5 py-3.5"
        >
          <Info size={16} className="mt-0.5 shrink-0 text-cyan-300" />
          <div className="min-w-0 flex-1">
            <Markdown className="text-[15px]">{step.narrative}</Markdown>
          </div>
        </motion.div>
      )}
